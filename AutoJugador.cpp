...
AutoJugador::AutoJugador(int vel, int x0, int y0):ObjetoGrafico(vel){
	
	matriz[0][0]=220;  matriz[0][1]=219;  matriz[0][2]=223;  matriz[0][3]=0;   matriz[0][4]=0;   matriz[0][5]=0;   matriz[0][6]=219;   matriz[0][7]=219;  matriz[0][8]=219; 
	...
	matriz[4][0]=0;    matriz[4][1]=219;  matriz[4][2]=0;    matriz[4][3]=0;   matriz[4][4]=0;   matriz[4][5]=0;   matriz[4][6]=219;   matriz[4][7]=219;  matriz[4][8]=201;
	matriz[5][0]=0;    matriz[5][1]=219;  matriz[5][2]=0;    matriz[5][3]=0;   matriz[5][4]=0;   matriz[5][5]=219; matriz[5][6]=219;   matriz[5][7]=219;  matriz[5][8]=205;
	...
	matriz[10][0]=0;   matriz[10][1]=219; matriz[10][2]=0;   matriz[10][3]=0;  matriz[10][4]=0;  matriz[10][5]=219;matriz[10][6]=219;  matriz[10][7]=219; matriz[10][8]=205;
	matriz[11][0]=0;   matriz[11][1]=219; matriz[11][2]=0;   matriz[11][3]=0;  matriz[11][4]=0;  matriz[11][5]=0;  matriz[11][6]=219;  matriz[11][7]=219; matriz[11][8]=187;
	...
	matriz[15][0]=220; matriz[15][1]=219; matriz[15][2]=223; matriz[15][3]=0;  matriz[15][4]=0;  matriz[15][5]=0;  matriz[15][6]=219;  matriz[15][7]=219; matriz[15][8]=219;
...
void AutoJugador::setLimit(int x0, int x1,int y0, int y1){
	maxLimitX = x1;
	maxLimitY = y1;
	minLimitX = x0;
	minLimitY = y0;
...
bool AutoJugador::update(int direccion){
	bool moves = false;
